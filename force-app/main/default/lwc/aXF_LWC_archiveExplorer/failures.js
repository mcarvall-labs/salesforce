...
const CODE_LABEL = {
  ...
  POLICY_MISSING: labels.codePolicy,
  POLICY_DISABLED: labels.codePolicy,
  POLICY_INVALID: labels.codePolicy,
  RUN_IN_PROGRESS: labels.codeRunInProgress,
  ASYNC_UNAVAILABLE: labels.codeAsync
};

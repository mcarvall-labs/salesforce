...
export default class AXF_LWC_overdueExpensesAlert extends LightningElement {
    ...
    async handleConfirmSettle() {
        ...
        this.isLoading = true;
        try {
            await settleEntry({ cashFlowId: this.selectedId, paymentDate: this.paymentDate, targetStatus: 'PAGA' });
            this.showToast('Sucesso', `Despesa "${this.selectedRecordName}" liquidada com sucesso!`, 'success');
            this.isModalOpen = false;

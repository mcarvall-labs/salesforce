...
export default class AXF_LWC_categoryLookup extends LightningElement {
    ...
    @wire(getCategoryOptions, { recordTypeDeveloperName: '$recordTypeDeveloperName' })
    ...
    @wire(getTopLevelCategoryOptions, { recordTypeDeveloperName: '$recordTypeDeveloperName' })
    ...
    async handleSaveNewCategory() {
        ...
        try {
            ...
            this.showToast('Sucesso', `Categoria "${created.displayLabel}" criada e selecionada.`, 'success');
        } catch (error) {

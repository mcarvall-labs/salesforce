...
export default class AXF_LWC_quickFlowActions extends LightningElement {
  ...
  get showInstallmentFields() {
    return ["FINANCIAMENTO", "FINANCIAMENTO_SAC", "CONSORCIO"].includes(
  ...
  syncVisibleFormValues() {
    ...
    this.template.querySelectorAll("lightning-input").forEach((input) => {
      ...
      if (
        !fieldName ||
        !Object.prototype.hasOwnProperty.call(this.form, fieldName)
      ) {
        return;
      }
  ...
  buildDto() {
    return {
      ...
      firstDueDate: this.showInstallmentFields
        ? this.form.firstDueDate
      ...
      provisioningStrategy: this.showRecurringFields
        ? this.form.provisioningStrategy
        : null,

...
export default class AXF_LWC_realTimeBalance extends LightningElement {
  ...
  get balance() {
    return this.hasData
      ? getFieldValue(this.account.data, BALANCE_FIELD)
      : null;
  }

  get currencyCode() {
    return (
      (this.hasData && getFieldValue(this.account.data, CURRENCY_FIELD)) ||
      "BRL"
    );
  }
  ...
  get lastSync() {
    return this.hasData
      ? getFieldValue(this.account.data, LAST_SYNC_FIELD)
      : null;
  }
